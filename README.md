...
Another approach would be to simplify the model by removing the excess variables and targetting a single company/franchise. The excessive number of categorical variables can present a problem in linear regression which seems to have an affect on my model.
